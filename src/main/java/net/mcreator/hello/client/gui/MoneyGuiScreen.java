...
import net.mcreator.hello.procedures.GetMoneyProcedure;
import net.mcreator.hello.network.MoneyGuiButtonMessage;
...
public class MoneyGuiScreen extends AbstractContainerScreen<MoneyGuiMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				GetMoneyProcedure.execute(entity), 90, 25, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.hello.money_gui.label_inculganeunggeumaeg"), 26, 26, -12829636, false);
	}
	...
	public void init() {
		...
		}).bounds(this.leftPos + 14, this.topPos + 99, 38, 20).build();
		...
		}).bounds(this.leftPos + 70, this.topPos + 99, 38, 20).build();
		...
		}).bounds(this.leftPos + 125, this.topPos + 99, 38, 20).build();
		guistate.put("button:button_1000", button_1000);
		this.addRenderableWidget(button_1000);
		imagebutton_money_tap = new ImageButton(this.leftPos + 37, this.topPos + -24, 32, 32, new WidgetSprites(ResourceLocation.parse("hello:textures/screens/money_tapon.png"), ResourceLocation.parse("hello:textures/screens/money_tapon.png")),
				e -> {
					if (true) {
						PacketDistributor.sendToServer(new MoneyGuiButtonMessage(3, x, y, z));
						MoneyGuiButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
		...
		imagebutton_quest_tap = new ImageButton(this.leftPos + 2, this.topPos + -24, 32, 32, new WidgetSprites(ResourceLocation.parse("hello:textures/screens/quest_tap.png"), ResourceLocation.parse("hello:textures/screens/quest_tap_on.png")), e -> {
			if (true) {
