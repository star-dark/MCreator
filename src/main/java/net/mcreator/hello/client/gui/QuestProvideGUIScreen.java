...
import net.mcreator.hello.network.QuestProvideGUIButtonMessage;
...
public class QuestProvideGUIScreen extends AbstractContainerScreen<QuestProvideGUIMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.hello.quest_provide_gui.label_bosang"), 41, 53, -12829636, false);
		guiGraphics.drawString(this.font,

				BringRewardProcedure.execute(entity), 69, 52, -12829636, false);
	}
	...
	public void init() {
		...
		}).bounds(this.leftPos + 23, this.topPos + 80, 59, 20).build();
		...
		}).bounds(this.leftPos + 100, this.topPos + 80, 57, 20).build();
