...
import net.mcreator.hello.network.QuestFinishedButtonMessage;
...
public class QuestFinishedScreen extends AbstractContainerScreen<QuestFinishedMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("hello:textures/screens/question.png"), this.leftPos + 22, this.topPos + 26, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.hello.quest_finished.label_bosang"), 44, 55, -12829636, false);
		guiGraphics.drawString(this.font,

				BringRewardProcedure.execute(entity), 70, 55, -12829636, false);
	}
	...
	public void init() {
		...
		}).bounds(this.leftPos + 43, this.topPos + 82, 86, 20).build();
