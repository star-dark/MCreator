...
import net.mcreator.hello.procedures.KillpigProcedure;
...
public class PigEntity extends Monster {
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(HelloModEntities.PIG.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
