...
public class HelloModVariables {
	...
	public static class MapVariables extends SavedData {
		...
		public ItemStack reward_man = ItemStack.EMPTY;
		public ItemStack reward_ochun = ItemStack.EMPTY;
		public ItemStack reward_chun = ItemStack.EMPTY;
		...
		public void read(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			reward_man = ItemStack.parseOptional(lookupProvider, nbt.getCompound("reward_man"));
			reward_ochun = ItemStack.parseOptional(lookupProvider, nbt.getCompound("reward_ochun"));
			reward_chun = ItemStack.parseOptional(lookupProvider, nbt.getCompound("reward_chun"));
		}

		@Override
		public CompoundTag save(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			nbt.put("reward_man", reward_man.saveOptional(lookupProvider));
			nbt.put("reward_ochun", reward_ochun.saveOptional(lookupProvider));
			nbt.put("reward_chun", reward_chun.saveOptional(lookupProvider));
			return nbt;
		}
	...
	public static class PlayerVariables implements INBTSerializable<CompoundTag> {
		...
		public String QuestContents1 = "";
		public String QuestContents2 = "";
		public double Questgoal1 = 0;
		public double Questprogress1 = 0;
		public double Questgoal2 = 0;
		public double Questprogress2 = 0;
		public boolean MainQuestExist = false;
		public boolean SubQuestExist = false;
		...
		public double my_money = 0.0;
		public double reward_money = 0;
		...
		public CompoundTag serializeNBT(HolderLookup.Provider lookupProvider) {
			...
			nbt.putString("quest_Contents", quest_Contents);
			nbt.putString("QuestContents1", QuestContents1);
			nbt.putString("QuestContents2", QuestContents2);
			nbt.putDouble("Questgoal1", Questgoal1);
			nbt.putDouble("Questprogress1", Questprogress1);
			nbt.putDouble("Questgoal2", Questgoal2);
			nbt.putDouble("Questprogress2", Questprogress2);
			nbt.putBoolean("MainQuestExist", MainQuestExist);
			nbt.putBoolean("SubQuestExist", SubQuestExist);
			...
			nbt.putDouble("reward_money", reward_money);
			nbt.putDouble("reward_money2", reward_money2);
			nbt.putDouble("reward_money1", reward_money1);
		...
		public void deserializeNBT(HolderLookup.Provider lookupProvider, CompoundTag nbt) {
			quest_Contents = nbt.getString("quest_Contents");
			QuestContents1 = nbt.getString("QuestContents1");
			QuestContents2 = nbt.getString("QuestContents2");
			Questgoal1 = nbt.getDouble("Questgoal1");
			Questprogress1 = nbt.getDouble("Questprogress1");
			Questgoal2 = nbt.getDouble("Questgoal2");
			Questprogress2 = nbt.getDouble("Questprogress2");
			MainQuestExist = nbt.getBoolean("MainQuestExist");
			SubQuestExist = nbt.getBoolean("SubQuestExist");
			...
			reward_money = nbt.getDouble("reward_money");
			reward_money2 = nbt.getDouble("reward_money2");
			reward_money1 = nbt.getDouble("reward_money1");
