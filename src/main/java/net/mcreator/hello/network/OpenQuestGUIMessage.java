...
@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD) public record OpenQuestGUIMessage(int eventType, int pressedms) implements CustomPacketPayload {
	...
	public static final StreamCodec<RegistryFriendlyByteBuf, OpenQuestGUIMessage> STREAM_CODEC = StreamCodec.of(
			(RegistryFriendlyByteBuf buffer, OpenQuestGUIMessage message) -> {
	...
	@Override public Type<OpenQuestGUIMessage> type() {
		return TYPE;
	}
