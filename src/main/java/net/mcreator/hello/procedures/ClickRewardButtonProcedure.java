...
_player.displayClientMessage(Component.literal("\uBCF4\uC0C1\uC744 \uD68D\uB4DD\uD558\uC600\uC2B5\uB2C8\uB2E4"), false);if(entity instanceof Player _player) _player.closeContainer();if (entity.getData(HelloModVariables.PLAYER_VARIABLES).MainRewardRequest) {{
