...
public class KillpigProcedure {
	public static void execute(Entity sourceentity) {
		...
		if ((sourceentity.getData(HelloModVariables.PLAYER_VARIABLES).QuestContents1).equals("\uB3FC\uC9C0 \uC138\uB9C8\uB9AC\uB97C \uC8FD\uC5EC\uB77C")) {
			if (sourceentity.getData(HelloModVariables.PLAYER_VARIABLES).Questprogress1 < sourceentity.getData(HelloModVariables.PLAYER_VARIABLES).Questgoal1) {
				{
