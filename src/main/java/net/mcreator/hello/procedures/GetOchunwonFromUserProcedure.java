...
if (
entity == null ) return ;
if (entity.getData(HelloModVariables.PLAYER_VARIABLES).my_money>5000) {if (entity instanceof Player _player) {
ItemStack _setstack = new ItemStack(HelloModItems.OCHUNWON.get()).copy();
